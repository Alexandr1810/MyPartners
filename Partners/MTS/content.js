...
function FindPaste(){
  ...
  try{
    if (document.getElementsByTagName("h4")[0].innerHTML == 'Время визита монтажника') {
      if (document.getElementsByTagName("h4")[0].innerHTML.indexOf("tooltiptext1") < 0) {
        document.getElementsByTagName("h4")[0].innerHTML += '<span class="tooltiptext1" style="">Выбираем временной интервал, если МТС подключает по своим линиям. Монтажник в таком случае придет к началу выбранного временного интервала.</span>'
        document.getElementsByTagName("h4")[2].innerHTML += '<span class="tooltiptext2" style="">ФИО указываем с большой буквы без лишних пробелов. Контактный и дополнительный номер записываем со второй цифры без пробелов и тире.<br>Пример: 9332660125.</span>'
        document.getElementsByTagName("h4")[3].innerHTML += '<span class="tooltiptext3" style="">Указываем название ТП, которое указано на официальном сайте, полную стоимость после промопериода (при наличии). Если в ТП предусмотрена скидка, либо мы используем агентское предложение - заполняем поле «Акции», записывая в «Название акции» название ТП, далее период действия скидки и стоимость по этой скидке (самостоятельно придумывать скидки нельзя!). В поле «Оборудование» указываем галочками нужное оборудование и вариант его использования, а в ячейке напротив - стоимость и количество.<br>Поле №6 («Комментарий»)<br>По возможности указываем информацию о наличии кабеля и технологического отверстия. Остальное - по желанию.<br>Пример: телевизор смарт, набрать за час.</span>'
